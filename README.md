...
*Fracktal Works Note:*
Please Use only this variant of Klipper in this printer. Since there are features enabled such as ignore temp limits and multi mcu that would not work properly with vanilla Klipper. Do not test any other danger features.
